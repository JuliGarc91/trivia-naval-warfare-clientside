...
const About_Mission = () => {
  return (
    <div className="">
      ...
      <div className="h-screen bg-fixed bg-cover" style={{ backgroundImage: "url('https://res.cloudinary.com/dwygxzqku/image/upload/v1717947883/battleship%20app/water.jpg')" }}>
        <div className="flex flex-row items-center justify-center mx-5 sm:mx-24 lg:mx-48">
          ...
          <h1 className=" text-black font-bold text-4xl md:text-5xl lg:text-6xl my-12 py-5 border-4 px-5 border-black text-center bg-white/50" style={{ fontFamily: "Black Ops One, system-ui", fontStyle: 'normal' }}>
            The Mission
          </h1>
          <hr className="border-2 border-black w-24" />
          <div className="border-4 border-black rounded-full p-5"></div>
        </div>
        <div className="mx-5 sm:mx-10 md:mx-24 lg:mx-48 px-10 border-4 border-black mb-48 bg-white/50" style={{ fontFamily: "Kode Mono, monospace", fontStyle: 'normal' }}>
