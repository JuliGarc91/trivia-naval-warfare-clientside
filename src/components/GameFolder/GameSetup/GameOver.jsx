...
const GameOver = ({ winner }) => {
  return (
    <div className="flex flex-col justify-center items-center bg-zinc-700/80 p-8 border-4 border-black">
      <h1 className="text-center text-6xl animate-ping" style={{ fontFamily: "Black Ops One, system-ui", fontStyle: 'normal' }}>Game Over</h1>
      <br/>
      ...
      <br/>
      <p className="text-4xl text-yellow-400 animate-pulse" style={{ fontFamily: "Black Ops One, system-ui", fontStyle: 'normal' }}>{`Congratulations ${winner} you win!`}</p>
      <br/>
      <Link to="/">
