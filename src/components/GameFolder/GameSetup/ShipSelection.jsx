      ...
      <div className="border-4 border-black">
        ...
        <fieldset className=" border-black">
          ...
          <div className="bg-red-500 p-1">
            ...
            />
            <label htmlFor="carrier" className="bg-navy/40 p-1 ml-1">Carrier ⬛ ⬛ ⬛ ⬛ ⬛</label>
          </div>
          <div className="bg-blue-500 p-1">
            <input
              ...
              onChange={handleShipSelection}
            />
            <label htmlFor="battleship" className="bg-navy/40 p-1 ml-1">Battleship ⬛ ⬛ ⬛ ⬛ </label>
          </div>
          <div className="bg-green-700 p-1">
            <input
              ...
              onChange={handleShipSelection}
            />
            <label htmlFor="cruiser" className="bg-navy/40 p-1 ml-1">Cruiser ⬛ ⬛ ⬛ </label>
          </div>
          <div className="bg-purple-700 p-1">
            <input
              ...
              onChange={handleShipSelection}
            />
            <label htmlFor="submarine" className="bg-navy/40 p-1 ml-1">Submarine ⬛ ⬛ ⬛ </label>
          </div>
          <div className="bg-yellow-300 p-1">
            <input
              ...
              onChange={handleShipSelection}
            />
            <label htmlFor="destroyer" className="bg-navy/40 p-1 ml-1">Destroyer ⬛ ⬛ </label>
          </div>
        </fieldset>
      </div>
    </div>
