...
const GameSetup = () => {
  ...
  return (
    ...
    <div className="h-screen bg-cover flex justify-center items-center text-white bg-fixed" style={{ backgroundImage: "url('https://res.cloudinary.com/dwygxzqku/image/upload/v1717950846/battleship%20app/controllers.jpg')" }}>
