  ...
  return (
    <>
        ...
        <div className='bg-forest/60 shadow-2xl backdrop-brightness-150 backdrop-blur-md bg-opacity-90 w-[65vw] h-auto relative z-10'>
            ...
            <div className='bg-forest/60 shadow-2xl backdrop-brightness-150 backdrop-blur-md bg-opacity-90 overflow-y-auto w-[65vw] relative z-10 h-[60vh] border-2 border-black'>
                <RssFeed/>
            </div>
        </div>
    </>
